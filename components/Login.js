    ...
    <div className={styles.container}>
      <div className={styles.leftContainer}>
        <div className={styles.logo}>
            ...
            <Image src="/inverted_logo.png" alt="Twitter logo" width={50} height={50} onClick={()=>setShowHashtag(false)} className={styles.twitterLogo} />
        </div>
        <div className={styles.users}>
          <div className={styles.usersInfo}> 
            <FontAwesomeIcon icon={faUser} style={{color: "#ffffff"}}className={styles.userIcon} size="2x"/>
