    ...
    <div className={styles.Container}>
      <div className={styles.headerLogin}>
        ...
        <div className={styles.lastHeader}>
          ...
          <button className={styles.addTweet} onClick={() => writeTweet()}>
            {" "}
            Tweet
          </button>
        </div>
      ...
      <div className={styles.tweetContainer}>{tweetTodips}</div>
    </div>
  );
}
